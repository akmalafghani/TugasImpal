					...
					<div class="container">
						...
						<!-- Logo -->
							<div id="logo">
								...
								<h1><a href="cari_pegawai.php">Cari Akun</a></h1>
							</div>
					...
					<section class="container">
						<div class="row">
							<section class="8u 12u(mobile)">
								<p> Cari data yang akan dihapus berdasarkan kode_pegawai</p>
								<form method="post">
								  <div class="form_settings">
									<p><span>Kode Pegawai</span><input type="text" name="input_cari" value=""></p>
									...
									<?php
										...
										if ((isset($_POST['cari_pegawai'])) and ($_POST['input_cari']<>"")) {
											...
											$sql = "delete from pegawai where kode_pegawai='$input_cari'";
											...
											if ($query) {
												...
												<script language="JavaScript">
													...
													document.location='hapus_pegawai.php';
												</script>
												<?php
											}
										}
