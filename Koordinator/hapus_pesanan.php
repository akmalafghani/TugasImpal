					...
					<div class="container">
						...
						<!-- Logo -->
							<div id="logo">
								...
								<h1><a href="hapus_pesanan.php">Hapus Pesanan</a></h1>
							</div>
					...
					<section class="container">
						<div class="row">
							<section class="8u 12u(mobile)">
								<p> Cari data yang akan dihapus berdasarkan kode pesanan</p>
								<form method="post">
								  <div class="form_settings">
									<p><span>Kode Pesanan</span><input type="text" name="input_cari" value=""></p>
									...
									<?php
										...
										if ((isset($_POST['cari_pesanan'])) and ($_POST['input_cari']<>"")) {
											...
											$sql = "delete from pesanan where kode_pesanan='$input_cari'";
											$query = mysqli_query($connect,$sql);
											if ($query) {
												?>
												<script language="JavaScript">
													alert('Hapus Data Pesanan berhasil');
												...
												?>
												<script language="JavaScript">
													alert('Hapus Data Pesanan GAGAL');
													document.location='hapus_pesanan.php';
												</script>
												<?php
											}
										}
