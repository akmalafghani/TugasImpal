					...
					<div class="container">
						...
						<!-- Logo -->
							<div id="logo">
								...
								<h1><a href="index_manager.php">CMART</a></h1>
							</div>

						<!-- Nav -->
							<nav id="nav">
								<ul>
									<li class="active"><a href="index_manager.php">Home</a></li>
									<li>
										<a href="#" class="icon fa-caret-down">Drop Down Menu</a>
										<ul>
											<li>
                                                <a href="Manager/lihat_akun.php">lihat Akun</a>
                                                </li>
											<li>
                                                <a href="Manager/lihat_pesanan.php">Pesanan</a>
                                                </li>
											<li>
                                                <a href="Manager/lihat_barang.php">Barang</a>
                                                </li>
											<li>
                                                <a href="Manager/lihat_pegawai.php">Pegawai</a>
                                                </li>
										</ul>
									</li>
